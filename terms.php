...
<body>
    <div class="page_wrapper page-index">
        ...
        <div id="content" class="page_content">
            <a id="page_content--open_menu_link" href="#open_menu" class="page_content--open_menu_link">Open Menu</a>

            

            <div class="page_content--artist">
                <h2 class="page_content--artist_heading">Terms of Service</h2>

                <p><b>1 &nbsp;Acceptance The Use Of Art Pad UCF Terms and Conditions</b></p>
...
<p>For any further information please email <a href='mailto:jonathan@jonnyroboto.com'> Art Pad UCF </a>Team</p>
        ...
        <div id="page_content--to_top_wrapper" class="page_content--to_top_wrapper">
            <a href="#content" class="page_content--to_top_link scroll">Up</a>
        </div>
